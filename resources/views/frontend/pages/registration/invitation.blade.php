    ...
    <div class="container my-4">
        <div id="card" class="border rounded" style="width: 378px; margin: auto; background-color:white">
            <div class="position-relative">
                ...
                <div class="d-flex justify-content-between align-items-center gap-2 pe-4 ps-4" style="margin-bottom: 210px">
                ...
                <div class="position-absolute d-flex justify-content-center" style="top: 7%; left:20%">
