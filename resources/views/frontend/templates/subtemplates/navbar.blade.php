  ...
  <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
          <ul class="navbar-nav d-flex align-items-center">
              ...
              <li class="nav-item d-sm-hidden mb-3 mb-lg-0">
                  <!-- Trigger modal -->
                  <a href="https://docs.google.com/forms/d/14Wgay0Da3iaeGmemD_bLYWucFVeOpafX6KLKJLqH2WU/edit"
                      style="background: linear-gradient(90deg, #E82036, #750002); padding: 10px 20px; color: white; font-weight: bold; border-radius: 5px; font-size: 20px; height: 38px; width: 147px; text-decoration: none">Survei Kepuasan</a>
              </li>
          </ul>
      </div>
  </div>
