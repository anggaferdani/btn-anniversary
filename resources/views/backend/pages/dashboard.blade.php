                            ...
                            <div class="card position-relative overflow-hidden p-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-baseline">
                                        ...
                                        <div class="percentage" style="font-size: 20px;">({{ number_format($percentageVerified, 2) }}%)</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card position-relative overflow-hidden p-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-baseline">
                                        ...
                                        <div class="percentage" style="font-size: 20px;">({{ number_format($percentageUnverified, 2) }}%)</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card position-relative overflow-hidden p-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-baseline">
                                        ...
                                        <div class="percentage" style="font-size: 20px;">({{ number_format($percentageOffline, 2) }}%)</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card position-relative overflow-hidden p-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-baseline">
                                        ...
                                        <div class="percentage" style="font-size: 20px;">({{ number_format($percentageOnline, 2) }}%)</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card position-relative overflow-hidden p-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-baseline">
                                        ...
                                        <div class="percentage" style="font-size: 20px;">({{ number_format($percentageHadir, 2) }}%)</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card position-relative overflow-hidden p-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-baseline">
                                        ...
                                        <div class="percentage" style="font-size: 20px;">({{ number_format($percentageNotHadir, 2) }}%)</div>
                                    </div>
                                </div>
                            </div>
                        </div>
