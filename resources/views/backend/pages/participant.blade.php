    ...
    <div class="col-12">
      ...
      <div class="card">
        <div class="card-header">
          <div class="ms-auto">
            <form action="{{ route('participant.index') }}" class="">
              <div class="d-flex gap-1">
                ...
                <a href="{{ route('participant.index') }}" class="btn btn-icon btn-dark-outline"><i class="fa-solid fa-times"></i></a>
              </div>
            </form>
          </div>
        </div>
...
<div class="modal modal-blur fade" id="createModal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <form action="{{ route('participant.store') }}" method="POST" class="">
        @csrf
...
<div class="modal modal-blur fade" id="edit{{ $participant->id }}" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <form action="{{ route('participant.update', $participant->id) }}" method="POST" class="">
        @csrf
        @method('PUT')
        <div class="modal-header">
