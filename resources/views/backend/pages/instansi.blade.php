    ...
    <div class="col-12">
      ...
      <div class="card">
        <div class="card-header">
          <div class="ms-auto">
            <form action="{{ route('admin.instansi.index') }}" class="">
              <div class="d-flex gap-1">
                ...
                <a href="{{ route('admin.instansi.index') }}" class="btn btn-icon btn-dark-outline"><i class="fa-solid fa-times"></i></a>
              </div>
            </form>
          </div>
        </div>
              ...
              @foreach ($instansis as $instansi)
                <tr>
                  ...
                  <td>
                    ...
                    <button type="button" class="btn btn-icon btn-danger" data-bs-toggle="modal" data-bs-target="#delete{{ $instansi->id }}"><i class="fa-solid fa-trash"></i></button>
                  </td>
                </tr>
              @endforeach
            </tbody>
...
<div class="modal modal-blur fade" id="createModal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <form action="{{ route('admin.instansi.store') }}" method="POST" class="">
        @csrf
...
@foreach ($instansis as $instansi)
<div class="modal modal-blur fade" id="edit{{ $instansi->id }}" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <form action="{{ route('admin.instansi.update', $instansi->id) }}" method="POST" class="">
        @csrf
        @method('PUT')
        <div class="modal-header">
        ...
        <div class="modal-body">
          <div class="mb-3">
            <label class="form-label required">Name</label>
            <input type="text" class="form-control" name="name" placeholder="Name" value="{{ $instansi->name }}" autocomplete="off">
            @error('name')<div class="text-danger">{{ $message }}</div>@enderror
          </div>
          <div class="mb-3">
            <label class="form-label required">Max Participant</label>
...
@foreach ($instansis as $instansi)
<div class="modal modal-blur fade" id="delete{{ $instansi->id }}" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
    <div class="modal-content">
      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      <div class="modal-status bg-danger"></div>
      <form action="{{ route('admin.instansi.destroy', $instansi->id) }}" method="POST">
        @csrf
        @method('Delete')
