    ...
    <div class="collapse navbar-collapse" id="sidebar-menu">
      <ul class="navbar-nav pt-lg-3">
        @if(auth()->user()->role == 1)
          ...
          <li class="nav-item {{ Route::is('admin.spin') ? 'active' : '' }}"><a class="nav-link {{ Route::is('admin.spin') ? 'fw-bold' : '' }}" href="{{ route('admin.spin') }}" ><span class="nav-link-icon d-md-none d-lg-inline-block"><i class="fa-solid fa-tag"></i></span><span class="nav-link-title">Spin</span></a></li>
          ...
          {{-- <li class="nav-item {{ Route::is('admin.quiz.*') ? 'active' : '' }}"><a class="nav-link {{ Route::is('admin.quiz.*') ? 'fw-bold' : '' }}" href="{{ route('admin.quiz.index') }}" ><span class="nav-link-icon d-md-none d-lg-inline-block"><i class="fa-solid fa-tag"></i></span><span class="nav-link-title">Quiz</span></a></li> --}}
              <li class="nav-item {{ Route::is('admin.spin.*') ? 'active' : '' }}"><a class="nav-link {{ Route::is('admin.spin.*') ? 'fw-bold' : '' }}" href="{{ route('admin.spin.index') }}" ><span class="nav-link-icon d-md-none d-lg-inline-block"><i class="fa-solid fa-tag"></i></span><span class="nav-link-title">Spin</span></a></li>
