    ...
    <div class="collapse navbar-collapse" id="sidebar-menu">
      <ul class="navbar-nav pt-lg-3">
        @if(auth()->user()->role == 1)
          ...
          <li class="nav-item {{ Route::is('admin.leaderboard.quiz') ? 'active' : '' }}"><a class="nav-link {{ Route::is('admin.leaderboard.quiz') ? 'fw-bold' : '' }}" href="{{ route('admin.leaderboard.quiz') }}" ><span class="nav-link-icon d-md-none d-lg-inline-block"><i class="fa-solid fa-tag"></i></span><span class="nav-link-title">Leaderboard Quiz</span></a></li>
          <li class="nav-item {{ Route::is('admin.quiz.*') ? 'active' : '' }}"><a class="nav-link {{ Route::is('admin.quiz.*') ? 'fw-bold' : '' }}" href="{{ route('admin.quiz.index') }}" ><span class="nav-link-icon d-md-none d-lg-inline-block"><i class="fa-solid fa-tag"></i></span><span class="nav-link-title">Quiz</span></a></li>
              <li class="nav-item {{ Route::is('admin.spin.*') ? 'active' : '' }}"><a class="nav-link {{ Route::is('admin.spin.*') ? 'fw-bold' : '' }}" href="{{ route('admin.spin.index') }}" ><span class="nav-link-icon d-md-none d-lg-inline-block"><i class="fa-solid fa-tag"></i></span><span class="nav-link-title">Spin By ID</span></a></li>
              <li class="nav-item {{ Route::is('admin.spin.*') ? 'active' : '' }}"><a class="nav-link {{ Route::is('admin.spin.*') ? 'fw-bold' : '' }}" href="{{ route('admin.spin.kursi') }}" ><span class="nav-link-icon d-md-none d-lg-inline-block"><i class="fa-solid fa-tag"></i></span><span class="nav-link-title">Spin By Kursi</span></a></li>
          ...
          <li class="nav-item {{ Route::is('admin.history.quiz') ? 'active' : '' }}"><a class="nav-link {{ Route::is('admin.history.quiz') ? 'fw-bold' : '' }}" href="{{ route('admin.history.quiz') }}" ><span class="nav-link-icon d-md-none d-lg-inline-block"><i class="fa-solid fa-user"></i></span><span class="nav-link-title">Quiz History</span></a></li>
        @endif
        @if(auth()->user()->role == 2)
